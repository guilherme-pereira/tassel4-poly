package net.maizegenetics.wizard;
...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    static Icon BACK_ICON = new ImageIcon((URL)getImage("backIcon.gif"));
    static Icon NEXT_ICON = new ImageIcon((URL)getImage("nextIcon.gif"));
    static Icon FINISH_ICON = new ImageIcon((URL)getImage("cancelIcon.gif"));
    static Icon CANCEL_ICON = new ImageIcon((URL)getImage("finishIcon.gif"));

     
    private WizardModel wizardModel;
    private WizardController wizardController;
    private JDialog wizardDialog;
    private DataTreePanel dataTree;
     ...
     */    
    public Wizard(DataTreePanel tree) {
        this((Frame)null, tree);
    }
     ...
     */    
    public Wizard(Dialog owner, DataTreePanel tree) {
        wizardModel = new WizardModel();
        wizardDialog = new JDialog(owner);
        wizardDialog.setMinimumSize(new Dimension(500, 375));
        dataTree = tree;
        initComponents();
    }
     ...
     */    
    public Wizard(Frame owner, DataTreePanel tree) {
        wizardModel = new WizardModel();
        wizardDialog = new JDialog(owner);
        wizardDialog.setMinimumSize(new Dimension(500, 375));
        dataTree = tree;
   ...
   /**
    ...
    private void initComponents() {
        ...
        backButton = new JButton(new ImageIcon("net/maizegenetics/wizard/backIcon.gif"));
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName("net.maizegenetics.wizard.Wizard");
...
////                ResourceBundle.getBundle("net.maizegenetics.wizard.wizard");
//
