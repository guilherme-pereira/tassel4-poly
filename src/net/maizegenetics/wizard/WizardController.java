...
public class WizardController implements ActionListener {
    ...
    private void nextButtonPressed() {
        try {
            ...
            if (descriptor.getPanelDescriptorIdentifier().equals(net.maizegenetics.wizard.panels.TestPanel2Descriptor.IDENTIFIER)) {
                if (descriptor.getData() != null) {
                    descriptor.getWizard().getDataTreePanel().addDataSet(descriptor.getData(), DataTreePanel.NODE_TYPE_DEFAULT);
                }
                else {
                    JOptionPane.showMessageDialog(wizard.getDialog(), "Unable to read file, please check file selection options.");
                }
            }
            else if (descriptor.getPanelDescriptorIdentifier().equals(net.maizegenetics.wizard.panels.TestPanel3Descriptor.IDENTIFIER)) {
                if (((net.maizegenetics.wizard.panels.TestPanel3)descriptor.getPanelComponent()).isLDChecked()) {
                    descriptor.getWizard().getDataTreePanel().addDataSet(descriptor.getData(), DataTreePanel.NODE_TYPE_DEFAULT);
                }
                else if (((net.maizegenetics.wizard.panels.TestPanel3)descriptor.getPanelComponent()).isImputeChecked()) {
                    descriptor.getWizard().getDataTreePanel().addDataSet(descriptor.getData(), DataTreePanel.NODE_TYPE_DEFAULT);
                }
            }
            ...
            JOptionPane.showMessageDialog(wizard.getDialog(), "Unable to read selected file " + e);
        }
        catch(Error e) {
            JOptionPane.showMessageDialog(wizard.getDialog(), "Unable to read selected file " + e);
        }
