...
public class FastqToPETagCountPlugin extends AbstractPlugin {
     ...
     * @param inputFileSWithBarcode  Filename of input Fastq file with barcode
     * @param inputFileSWithoutBarcode  Filename of input Fastq file without barcode
    ...
    public void countTags(String keyFileS, String enzyme, String inputFileSWithBarcode, String inputFileSWithoutBarcode, int minCount, int tagLengthInLong) {
        ...
        try {
            ...
            while (((temp = brF.readLine()) != null)) {
                try {
                    brB.readLine();
                    sequenceF = brF.readLine(); sequenceB = brB.readLine();
                    brF.readLine(); brB.readLine();
                    qualityScoreF = brF.readLine(); qualityScoreB = brB.readLine();
                    allReads++;
